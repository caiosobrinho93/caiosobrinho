...
// 3. Replace Hero Header
const heroStartIdx = content.indexOf('{/* 🔮 Spatial Hero Header */}');
const heroEndIdx = content.indexOf('{/* Grid Central */}');
...
if (heroStartIdx !== -1 && heroEndIdx !== -1) {
  ...
  content = content.substring(0, heroStartIdx) + newHero + content.substring(heroEndIdx);
}

// 4. Add Notifications Modal right before the final closing div of DashboardPage
...
console.log('Hero section updated with XP bar and Notifications Modal added');
