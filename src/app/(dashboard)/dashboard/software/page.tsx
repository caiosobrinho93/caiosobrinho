                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] font-mono text-primary shrink-0">v{item.version}</span>
                    </div>
                    <p className="text-[10px] text-muted-foreground truncate leading-tight">{item.category || 'Geral'}</p>
                  </div>
                  {/* Actions */}
